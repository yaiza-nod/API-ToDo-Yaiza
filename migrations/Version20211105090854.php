 ...
 */
final class Version20211105090854 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tarea CHANGE id_usuario_id id_usuario_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tarea CHANGE id_usuario_id id_usuario_id INT NOT NULL');
    }
}
